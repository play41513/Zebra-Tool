...
#ifndef CMDThreadAccessH
#define CMDThreadAccessH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TCMDThreadAccess : public TThread
{
private:
	AnsiString strCMD;
	bool EnumUSB();
...
public:
	__fastcall TCMDThreadAccess(bool CreateSuspended,HWND hWnd,INI_DESCRIPOR *ini);
	void SetCommandLine(AnsiString cmd);
	AnsiString DosCommand();
	void SetThreadStep(DWORD Step);
	bool InitLED();
};
//---------------------------------------------------------------------------
#endif
