...
void PowerSupplyAccess::SetDeviceCOM()
{
	mSerialPortControl->CommPort_Set_Device_COM(0,INI_Desc->PSUCOMNum[0]);
	mSerialPortControl->CommPort_Set_Device_COM(1,INI_Desc->PSUCOMNum[1]);
}
...
AnsiString PowerSupplyAccess::FindAllPowerSupplyName()
{
	return mSerialPortControl->CommPort_SearchAllDevCOM();
}
