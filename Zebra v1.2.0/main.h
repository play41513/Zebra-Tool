...
const AnsiString APP_TITLE = "Zebra Test Tool  ver 1.2.0 ( Action Star)";
...
private:	// User declarations
	...
	bool HID_TurnOn();
	void HID_TurnOff();
	void Voltage_Test(AnsiString CMD,TPanel *pl_main,TPanel *pl_read,float MinVoltage,float MaxVoltage);
	...
	bool ReadInISet();
	bool SetInIVal(AnsiString DUTNAME);
