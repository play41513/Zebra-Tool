...
void __fastcall TFrmMain::plAD0Click(TObject *Sender)
{
	...
	if(numBtn ==15 )
		Voltage_Test(CHANGE_AD_PORT_NUM+IntToHex(numBtn,2),pl,pl_read_voltage_ad_15,-1,-1);
	else
	{
...
void __fastcall TFrmMain::pl_sys_powerDblClick(TObject *Sender)
{
	if(plAD->Height > 500)
		plAD->Height = 465;
	else
