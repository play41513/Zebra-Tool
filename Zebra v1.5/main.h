...
const AnsiString APP_TITLE = "Zebra Test Tool  ver 1.5 ( Action Star.2020)";
const AnsiString PASSWORD  = "SET";
const AnsiString MTTWORD   = "MTT";

//
const AnsiString CHANGE_IO_TO_AD    = "03 13 F1 CC ";
const AnsiString CHANGE_AD_PORT_NUM = "03 13 BB 1F "; //後面接00 ~ 0F、11~14
...
__published:	// IDE-managed Components
	...
	void __fastcall pl_sys_powerDblClick(TObject *Sender);
